...
?>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="form-group">
                        ...
                        <form method="post" action="hr_loan_save.php">
			...
			?>
                                ...
                                <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"  
                                                name="month" class="form-control pull-right" tabindex="4">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
    ...
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Allowances List</h3>
            </div>
            <div class="box-body">
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <?php $result = $db->prepare("SELECT * FROM hr_loan");
                            ...
                            <tr class="record">
                                ...
                                <td>Rs.<?php echo $row['amount_left']  ?></td>
                                <td>
