        ...
        <section class="content">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
				  ...
				  $ttr="incomplete";
                $result = $db->prepare("SELECT * FROM job_inspection_cat");
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <?php $result = $db->prepare("SELECT job_inspection.* , job_inspection_cat.name as cname FROM job_inspection JOIN job_inspection_cat ON job_inspection_cat.id = job_inspection.cat ");
