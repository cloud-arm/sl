...
<div class="form-group">		
	...
	?>
		<option style="color: green" value="<?php echo $row['product_id'];?>"><?php echo $row['name']; ?>  <?php echo $row['code']; ?> ___ {<span class="badge bg-green"> <?php echo $row['qty']; ?>}</span></span> </option>
	<?php
				}
			?>
                </select>
